...
▸ **calculateAmountReceived**(`originDomain`, `destinationDomain`, `originTokenAddress`, `destinationTokenAddress`, `amount`, `isNextAsset?`): `Promise`<`{amountReceived: BigNumberish; originSlippage: BigNumberish; routerFee: BigNumberish; destinationSlippage: BigNumberish;}`\>

Returns the estimate amount received.

#### Parameters

| Name                      | Type           | Default value | Description                                                 |
| :------------------------ | :------------- | :------------ | :---------------------------------------------------------- |
| `originDomain`            | `string`       | `undefined`   | The domain id of the Origin network.                        |
| `destinationDomain`       | `string`       | `undefined`   | The domain id of the destination network.                   |
| `originTokenAddress`      | `string`       | `undefined`   | The address of local or adopted token at origin domain      |
| `destinationTokenAddress` | `string`       | `undefined`   | The address of local or adopted token at destination domain |
| `amount`                  | `BigNumberish` | `undefined`   | The amounts of the tokens to swap.                          |
| `isNextAsset?`            | `boolean`      | `false`       | The flag if it's nextAsset at originDomain                  |

#### Returns

`Promise`<`{amountReceived: BigNumberish; originSlippage: BigNumberish; routerFee: BigNumberish; destinationSlippage: BigNumberish;}`\>

| Name                  | Type           | Description                                    |
| :-------------------- | :------------- | :--------------------------------------------- |
| `amountReceived`      | `BigNumberish` | The estimated amount received after the XCall. |
| `originSlippage`      | `BigNumberish` | The possible slippage at origin AMM.           |
| `routerFee`           | `BigNumberish` | The router fee charged for the XCall           |
| `destinationSlippage` | `BigNumberish` | The possible slippage at destination AMM       |
...
▸ `Static` **create**(`_config`, `_logger?`, `_chainData?`, `_chainReader?`): `Promise`<`NxtpSdkPool`\>
