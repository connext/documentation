...
▸ `Static` **create**(`_config`): `Promise`<[`NxtpSdkUtils`](NxtpSdkUtils.md)\>
...
[packages/agents/sdk/src/sdkUtils.ts:52](https://github.com/connext/monorepo/blob/6af80580f/packages/agents/sdk/src/sdkUtils.ts#L52)
