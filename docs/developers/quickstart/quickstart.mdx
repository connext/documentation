...
- Read about [how to use callbacks](../guides/xcall-callback.md) to handle execution results back on the origin domain.
- Fork the [xapp-starter](https://github.com/connext/xapp-starter) repository and build your own xapp on top of the examples.
