...
Notice the token that is passed in is the TEST token on Goerli. You can read more about token flavors and why they matter [here](../concepts/faq/#what-are-token-flavors).
