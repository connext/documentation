      ...
      <Container>
        ...
        >
          <h1 style={{ fontWeight: "600" }}>
            Opportunities to win, be supported or earn with Connext
          </h1>
          ...
          >
            ...
            >
              ...
              >
                <h2>At a Hackathon?</h2>
                Leapfrog your competition and get all the support you need.
                You'll get into the winning ranks real fast with us!
              </p>
              <div>
                <p></p>
                {hacker.map((action) => (
          ...
          >
            ...
            >
              ...
              >
                <h2>Become a router</h2>
                Connext Routers form the backbone of the network, relaying funds
                and data between domains by providing liquidity
              </p>
              <div>
                <p></p>
                {router.map((action) => (
          ...
          >
            ...
            >
              ...
              >
                <h2>Build and get rewarded</h2>
                Join our builders track to work with some of the best developers
                in our ecosystem and get a chance to get rewarded in the future
              </p>
              <div>
                <p></p>
                {builder.map((action) => (
          ...
          >
            ...
            >
              ...
              >
                <h2>Connext Grant Program</h2>
                We offer financial and technical support for projects we believe
                in. Apply today for a grant and get started on your project!
              </p>
              <div>
                <p></p>
                {grant.map((action) => (
