    ...
    >
      <Container>
        ...
        >
          ...
          /> */}
          <h1 style={{ fontWeight: "700", textAlign: "left" }}>
            At a Hackathon?
          </h1>
          <div>
        ...
        >
          ...
          >
            <SwitchHorizontalIcon style={{ width: "120px", height: "120px" }} />
            <div>
              <h2 style={{ marginBottom: "0.5rem" }}>Become a Router</h2>
              <p style={{ margin: "0rem" }}>
                Connext Routers form the backbone of the network, relaying funds
                and data between domains.{" "}
              </p>
            </div>
          </WideCard>
        </Link>
